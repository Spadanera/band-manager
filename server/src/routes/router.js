...
router.use(async (req, res, next) => {
    if (req.url.startsWith("/invitations/band/") || req.url.startsWith("/deezer") || req.url.startsWith("/public")) {
        next();
    }
    else {
...
router.use("/public", require("./controllers/publicController").default);
